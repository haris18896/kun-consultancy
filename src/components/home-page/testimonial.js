      ...
      <div className='container'>
        <div className='grid-cols-1'>
          <div className='flex items-center justify-between mb-[65px]'>
            <h2 className='testimonial-title'>+250 Happy Clients</h2>
            <div className='swiper-button-wrap flex cursor-pointer text-[#999999] text-[30px]'>
              <div className='swiper-button transition-all hover:text-black mr-[10px]' ref={prevRef}>
                <AiIcons.AiOutlineLeft />
              </div>
              <div className='swiper-button transition-all hover:text-black' ref={nextRef}>
