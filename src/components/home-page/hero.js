        ...
        return (
          <SwiperSlide className='hero-item' key={i}>
            <div className={heroImage}>
              <Image src={heroItem?.image} alt={heroItem?.title} layout='fill' objectFit='cover' quality={70} priority />
            </div>
            <div className='container custom-container'>
              <div className={heroContent}>
                <div className='hero-inner grid grid-cols-12'>
                  ...
                  <div className='md:col-span-10 col-span-12'>
                    ...
                    />
                    <h2
                      className='md:text-[50px] md:leading-[50px] text-[25px] leading-[1.2] text-white mb-[45px] hero-slidedown delay-[600ms]'
                      dangerouslySetInnerHTML={{
              ...
              <div className='info text-white hover:text-primary transition-all text-[14px] uppercase absolute bottom-[100px] sm:right-[70px] right-auto z-[2]'>
                <a href='mailto:info@kunconsultingservices.com'>{heroItem?.heroContactInfo}</a>
              </div>
            </div>
