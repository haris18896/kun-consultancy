...
function ProjectContent(props) {
  ...
  const imagePath = `/images/services/${project.slug}/${project.image}`
            ...
            <div className='project-description md:pt-[80px] pt-[40px]'>
              <div className='container'>
                <div className='content'>
                  <h2 className='text-[36px] leading-[58px] pb-10'>Description</h2>
                  <div
                ...
                <div className='image md:pt-[85px] pt-[50px]'>
                  <Image
                    src={`/images/services/${project.slug}/${image.properties.src}`}
                    alt={image.alt}
                    width={1170}
                    height={610}
                    objectFit='cover'
  ...
  return (
    <article>
      <ProjectBanner title={project.title} excerpt={project.excerpt} categoryName={project.categoryName} image={imagePath} />
